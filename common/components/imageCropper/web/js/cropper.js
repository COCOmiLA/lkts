        ...
        var $widget = $(this).closest(".cropper-widget"),
            ...
            cropper = {
                ...
                init: function () {
                    ...
                    var settings = $.extend(
                        {
                            button: [cropper.$cropper_label, cropper.$upload_new_photo],
                            ...
                            onComplete: function (filename, response) {
                                ...
                                if (
                                    typeof options.onCompleteJcrop !== "undefined" &&
                                    typeof options.onCompleteJcrop === "string"
                                ) {
                    ...
                    if (options.deleteUrl) {
                        cropper.deleteUrl = options.deleteUrl;
                    }
                    cropper.$widget
                        .on("click", ".delete-photo", function () {
                            if (cropper.deleteUrl) {
                                $.post(cropper.deleteUrl)
                        ...
                        .on("click", ".crop-photo", function () {
                            ...
                            data["width"] = cropper.$img.css('width').trim('px');
                            data["height"] = cropper.$img.css('height').trim('px');
