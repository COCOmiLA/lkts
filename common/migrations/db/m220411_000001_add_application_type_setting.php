...
class m220411_000001_add_application_type_setting extends MigrationWithDefaultOptions
{
    ...
    {
        $this->delete('{{%application_type_settings}}', ['name' => 'hide_benefits_block']);
    }
}
