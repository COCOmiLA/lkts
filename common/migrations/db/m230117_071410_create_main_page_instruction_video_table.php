...
class m230117_071410_create_main_page_instruction_video_table extends MigrationWithDefaultOptions
{
    use createDropReferenceTable;

    private const TN = '{{%main_page_instruction_video}}';
    ...
    public function safeUp()
    {
        ...
        $this->createTable(
            ...
            [
                ...
                'autoplay' => $this->boolean()->defaultValue(false),
                'muted' => $this->boolean()->defaultValue(false),
                'loop' => $this->boolean()->defaultValue(false),
