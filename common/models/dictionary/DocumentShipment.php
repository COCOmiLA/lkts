...
class DocumentShipment extends ModelFrom1CByOData implements IArchiveQueryable, IRestorableReferenceDictionary, IFillableReferenceDictionary
{
    protected static $referenceClassName = 'Справочник.ТипыДоставкиДокументов';
    ...
    {
        return '{{%dictionary_document_shipment}}';
    }
