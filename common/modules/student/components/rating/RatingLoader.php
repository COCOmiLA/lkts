...
namespace common\modules\student\components\rating;
...
class RatingLoader extends Component implements \common\modules\student\interfaces\DynamicComponentInterface,
    \common\modules\student\interfaces\RoutableComponentInterface
{
    public $user_guid;
    public $componentName = "Рейтинг";
