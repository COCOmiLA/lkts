...
namespace common\modules\student\components\spravki;
...
class SpravkiLoader extends Component implements \common\modules\student\interfaces\DynamicComponentInterface,
    \common\modules\student\interfaces\RoutableComponentInterface
{
    public $user_guid;
    public $componentName = "Заказ справок";
