...
class SessionLoader extends Component implements \common\modules\student\interfaces\DynamicComponentInterface,
    \common\modules\student\interfaces\RoutableComponentInterface
{
    public $user_guid;
    public $componentName = "Расписание сессии";
    public $baseRoute = 'student/session';
