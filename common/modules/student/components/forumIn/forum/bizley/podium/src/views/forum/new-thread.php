...
use common\modules\student\components\forumIn\forum\bizley\podium\src\widgets\editor\EditorFull;
use common\modules\student\components\forumIn\forum\bizley\podium\src\widgets\poll\Poll;
    ...
    <div class="col-sm-10 col-sm-offset-1">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <?= $form->field($model, 'post')->label(false)->widget(EditorFull::class, ['options'=>['id'=>'editor-full']]); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
